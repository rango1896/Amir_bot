...
async def help_handler(event):
    help_text = (
        ...
        "🔹 **کارخونه میویی روشن / کارخونه میویی خاموش**\nچرخه کامل تولید و فروش کارخونه (هر ۲۶ ساعت).\n\n"
...
async def factory_cycle():
    ...
    while factory_active:
        try:
            ...
            print("⏳ تولید استارت خورد. سیستم ۲۶ ساعت صبر می‌کنه...")
            waited = 0
            # 86400 (24 ساعت) + 7200 (2 ساعت) = 93600
            while waited < 93600 and factory_active: # 26 ساعت
                await asyncio.sleep(60)
                waited += 60
