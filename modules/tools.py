...
async def help_handler(event):
    help_text = (
        ...
        "سلام! تمام دستورات من به صورت دسته‌بندی شده در زیر آمده است.\n\n"
        ...
        "🔹 **واکنش [آیدی/یوزرنیم/لینک] [ایموجی]** -> `واکنش https://t.me/TweetyChannel 🤣`\n"
